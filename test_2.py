...
animation_orange_points, = plt.plot([],[], 'o', color = 'orange')
...
def update(frame):
    ...
    data_blue_points_x = []
    data_blue_points_y = []
    data_orange_points_x = []
    data_orange_points_y = []
    ...
    animation_orange_points.set_data(data_orange_points_x, data_orange_points_y)
    ...
    return animation_red_points, animation_green_points, animation_blue_points, animation_orange_points
...
#1 period bolezni = 250 frames; 1 day = 50 frames при условии, что болезнь протекает у всех одинаково
# инкубационный период 2 дня = 100 frames; +0,01
