...
for i in range (k):
    ...
    persons.append(Person(
        ...
        random.uniform(0.1, 0.2),   #speed_x
        random.uniform(0.1, 0.2),   #speed_y
        chance   #chance
        np.random.random() * 2 * np.pi,   #angel
...
animation = FuncAnimation(figure, update, frames=np.arange(100), interval=50)
